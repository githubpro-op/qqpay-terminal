...
<div class="tiles-grid">    
  ...
  <div class="tile qqpanel" onclick="toggleModal('qqpanel-modal')">
  ...
  <div class="tile daily" onclick="toggleModal('dailyearn-modal')">
    <i>💹</i><span class="tile-title daily-title">Daily Earn</span>
    <div id="dailyMsg" class="fade daily-feed">Loading...</div>    
  </div>    

  <div class="tile p2p" onclick="toggleModal('p2p-modal')">
