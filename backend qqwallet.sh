...
<!-- ⚡ QQWALLET MODAL — FUTURISTIC FIXED VERSION -->
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  document.getElementById("wBalRS").innerText="₹"+wallet.balance_rs.toFixed(2);
  document.getElementById("wBalUSDT").innerText=wallet.balance_usdt.toFixed(4)+" ₮";
